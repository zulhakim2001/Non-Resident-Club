...
<head>
   ...
   <title>INFO NON_RESIDENT CLUB</title>
</head>

<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00ff5573;">
      PHP Complete INRC Application
   </nav>
         ...
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div class="form-group mb-3">
			 ...
			 <div class="mb-3">
               ...
               <input type="text" class="form-control" name="username" placeholder="please put your username">
            </div>
			 <div class="mb-3">
               <label class="form-label">Password:</label>
               <input type="password" class="form-control" name="password" placeholder="abcd123">
            </div>
